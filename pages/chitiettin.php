...
$row_ChiTietTin = mysql_fetch_array($chitiettin);
...
<div class="clear"></div>
<a class="btn_quantam" id="vne-like-anchor-1000000-3023795" href="#" total-like="<?php echo $row_ChiTietTin['SoLanXem'] ?>"></a>
...
<div class="clear"></div>
	<ul>
    	<?php      
        $tincungloai = TinCungLoai($idTin,$row_ChiTietTin['idLT']);
        while ($row_tincungloai = mysql_fetch_array($tincungloai)) {      
       ?>
        <li>       
             <a href="chitiet/<?php echo $row_tincungloai['idTin'] ?>-<?php echo $row_tincungloai['TieuDe_KhongDau'] ?>"><img src="upload/tintuc/<?php echo $row_tincungloai['urlHinh'] ?>" alt="anh"></a> <br />
 			       <a class="title" href="chitiet/<?php echo $row_tincungloai['idTin'] ?>-<?php echo $row_tincungloai['TieuDe_KhongDau'] ?>"><?php echo $row_tincungloai['TieuDe'] ?></a>
             <span class="no_wrap">   
        </li>
        <?php 
}
